...
| --- | --- | --- |
| Vihan Jayaraman | Finished animation panel and button to start animation for single pendulum simulation | [Ticket](https://github.com/tonyhieu/P1-Tactical-Apes/blob/main/src/SinglePendulum) |
